...
{
    public partial class WonkaService
    {
		...
		public WonkaService(string psContractAddress, bool pbInitChainEnv = true)
        {
            ...
            moMetadataSource = new WonkaBreMetadataTestSource();            
		...
		public async Task<bool> Init()
		{
			...
			{
                var web3                = GetWeb3();
                var ChronoLogDeployment = new ChronoLogDeployment();
            ...
            var Writer =
                new WonkaBizRulesXmlWriter(moEthEngineInit.Engine.RulesEngine);
        ...
        {
            var web3                = GetWeb3();
            var EngineDeployment    = new WonkaEngineDeploymentClassic();
            var RegistryDeployment  = new WonkaRegistryDeployment();
            var TestCntDeployment   = new WonkaTestContractDeployment();
            var ChronoLogDeployment = new ChronoLogDeployment();
        ...
        public async Task<bool> Execute(bool pbValidateTransaction = false)
        {
            ...
            WonkaBizRuleTreeReport Report = RulesEngine.Validate(NewProduct);
        ...
        public async Task<RuleTreeReport> ExecuteWithReportAsync(WonkaBizRulesEngine poRulesEngine, bool pbValidateWithinTransaction)
        {
			...
			if (pbValidateWithinTransaction)
			{
                ...
                var EthRuleTreeReport = new RuleTreeReport();
